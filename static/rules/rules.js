  ...
  },
  {
    ...
    event: {
      ...
      params: {
        effectedBy: 'ENGINE_TEMP',
        reason:
          'Engine temperature rises above 90C while vehicle is stationary. Check your radiator or re-park in the shadow',
      },
    },
  },
  {
    ...
    event: {
      ...
      params: {
        ...
        reason:
          'Fuel level increase by more than 20% while vechicle is in motion. Are you a fighter jet refueling mid-air?',
      },
    },
  },
  {
    ...
    event: {
      ...
      params: {
        effectedBy: 'FUEL_LEVEL',
        reason:
          'Fuel level decreased by more than 20% since last reading. Possible fuel leak',
      },
    },
  },
  {
  ...
  },
  {
    ...
    event: {
      ...
      params: {
        effectedBy: 'FUEL_LEVEL',
        reason:
          "Fuel can't increase in high speeds (unless you're flying a fighter jet refueling mid-air)",
      },
    },
  },
  {
  ...
  },
  {
    ...
    event: {
      ...
      params: {
        effectedBy: 'LOCATION',
        reason:
          'Location data out of range. Teleportation is prohibited in this airspace',
      },
    },
  },
  {
    ...
    event: {
      ...
      params: {
        effectedBy: 'LOCATION',
        reason:
          'Location change while vehicle is stationary. Teleportation is prohibited in this airspace',
      },
    },
  },
  {
